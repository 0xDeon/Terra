    ...
    <section id="community" className="py-40 section-padding bg-white">
      <div className="max-w-6xl mx-auto">
        <motion.div
          ...
          className="relative bg-gradient-brand rounded-[3rem] p-8 md:p-16 lg:p-24 text-center overflow-hidden border border-black/5 shadow-2xl"
        >
          ...
          <div className="relative z-10 flex flex-col items-center">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl xl:text-8xl font-black text-white tracking-tighter leading-[0.8] mb-6 md:mb-10 font-display italic">
              Start your <br />
              <span className="text-ink">Digital Harvest.</span>
            </h2>
            <p className="text-base md:text-xl lg:text-2xl text-white/80 font-medium max-w-2xl mx-auto mb-10 md:mb-14 leading-relaxed px-4 sm:px-0">
