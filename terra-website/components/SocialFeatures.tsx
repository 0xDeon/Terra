...
const FeatureCard = ({ title, description, children, className = "", delay = 0 }: FeatureCardProps) => (
  ...
  >
    <div className="p-6 md:p-10 pb-4 md:pb-6 relative">
    ...
    <div className="flex-1 px-6 md:px-10 pb-6 md:pb-10 flex items-center justify-center overflow-hidden">
      {children}
    </div>
  </motion.div>
);
...
export const SocialFeatures = () => {
  return (
    <section className="py-16 md:py-24 lg:py-32 bg-[#fff] overflow-hidden relative font-sans">
