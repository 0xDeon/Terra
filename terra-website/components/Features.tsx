...
export function Features() {
  return (
    <section id="garden" className="py-40 bg-[#FAFAFA] section-padding font-sans">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="text-5xl md:text-7xl font-black text-ink leading-tight mb-8 font-display">
            The social layer <br />
            <span className="gradient-text italic">you actually own.</span>
          </h2>
          <p className="text-xl md:text-2xl text-ink-light font-medium max-w-2xl">
        ...
        >
          {pillars.map((pillar) => (
            <motion.div
              ...
              whileHover={{ y: -10 }}
              className="group relative bg-surface-50 hover:bg-surface-100 rounded-[3rem] p-12 transition-all duration-500 border border-black/5"
            >
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-black text-ink mb-6 font-display">
                  {pillar.title}
                </h3>
